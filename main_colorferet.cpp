...
int main(int argc, const char * argv[]) {
    ...
    sprintf( path, "/home/diego/Imágenes/colorferet/colorferet/colorferet/dvd%s/data/images/", mes );
		   ...
		   std::cout << "No se detectaron ojos en: " << file <<std::endl;
                    ...
                    
                {
                    ...
                    if (!crop.empty())
                    {
                        ...
                        imwrite( path+std::string("eye-deteccion/eye-detection-")+argv[2]+std::string("-")+numstr2+std::string("-")+file, crop );
